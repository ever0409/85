...
VOLUNTARYCHECK=0
I=1
BOT=85  # You can put here other bots. Also you can change it to run more than one bot in the same server.
RELOADTIME=13  # Time between checking cpu calls of the cli process. Set the value high if your bot does not receive lots of messages.
